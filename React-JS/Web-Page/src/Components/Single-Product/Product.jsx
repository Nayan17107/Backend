            ...
            <Row className="gy-4">
                <Col md={6} className="text-center">
                    ...
                    <div className="d-flex justify-content-center gap-3">
                        <img src="/Img/img-1.jpg" alt="thumb1" className="thumb-img" />
                        <img src="/Img/img-2.jpg" alt="thumb2" className="thumb-img" />
                        <img src="/Img/img-3.jpg" alt="thumb3" className="thumb-img" />
                    </div>
                </Col>
                <Col md={6}>
